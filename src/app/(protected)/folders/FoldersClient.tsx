...
import { FolderIcon, FolderOpenIcon, PlusIcon, MusicalNoteIcon, Squares2X2Icon, TableCellsIcon, MagnifyingGlassIcon, XMarkIcon, Bars3Icon } from '@heroicons/react/24/outline'
...
function SortableFolderTableRow({ folder, songCount, onFolderClick }: SortableFolderTableRowProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
...
function SortableFolderItem({ folder, songCount, onFolderClick }: SortableFolderItemProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
        ...
        <div className="mb-6 flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            <div className="inline-flex rounded-md shadow-sm border overflow-hidden">
              <button
                className={`px-2.5 sm:px-3 py-2 sm:py-1.5 text-sm flex items-center justify-center ${view === 'grid' ? 'bg-gray-900 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'}`}
              ...
              <button
                className={`px-2.5 sm:px-3 py-2 sm:py-1.5 text-sm flex items-center justify-center border-l ${view === 'table' ? 'bg-gray-900 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'}`}
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Chansons</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Date de création</th>
                    </tr>
                  </thead>
