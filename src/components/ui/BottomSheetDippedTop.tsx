...
interface BottomSheetDippedTopProps {
  ...
  onClose?: () => void
  hideBorder?: boolean
  /** When false, only the dipped shape is shown (no floating X). */
  showClose?: boolean
}
 ...
 */
export function BottomSheetDippedTop({
  className,
  onClose,
  hideBorder = false,
  showClose = true,
}: BottomSheetDippedTopProps) {
  return (
    <div className={cn('relative z-[70] shrink-0 overflow-visible bg-background', className)}>
      ...
      >
        <path
          ...
          d={
            showClose
              ? 'M 0 32 V 12 Q 0 0 12 0 H 163.5 A 24 24 0 0 1 211.5 0 H 363 Q 375 0 375 12 V 32 Z'
              : 'M 0 32 V 12 Q 0 0 12 0 H 363 Q 375 0 375 12 V 32 Z'
          }
        />
      </svg>
    </div>
